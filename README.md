...
*******************************************************************************
https://salsa.debian.org/efi-team/shim/-/tree/debian/15.7-1_deb10u1
...
*******************************************************************************
* ```shim_15.7-1~deb10u1_amd64.log```
* ```shim_15.7-1~deb10u1_i386.log```
...
grub.debian,4,Debian,grub2,2.06-3~deb10u3,https://tracker.debian.org/pkg/grub2
...
current version (2.06-3~deb10u3) in Debian Buster. It is derived from
the upstream 2.06 release with a number of patches applied - see
...
*******************************************************************************
Buster is using Linux 4.19.269 (labelled as 4.19.0-23 in Debian). It
