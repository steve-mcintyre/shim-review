...
*******************************************************************************
https://salsa.debian.org/efi-team/shim/-/tree/debian/15.7-1

*******************************************************************************
### What patches are being applied and why:
*******************************************************************************
Three patches (see the patches dir here, or in the debian/patches dir
in the shim repo)
...
*******************************************************************************
* ```shim_15.7-1_amd64.log```
* ```shim_15.7-1_arm64.log```
* ```shim_15.7-1_i386.log```

*******************************************************************************
### What changes were made since your SHIM was last signed?
*******************************************************************************
We've moved forwards from 15.4 to 15.7 and dropped all the patches we
used to need as they're upstream. Then added the 3 patches listed above.
...
current version (2.06-7) in Debian Bookworm. It is derived from the
...
*******************************************************************************
Bookworm is using Linux 6.1.8 (labelled as 6.1.0-3 in Debian). It
