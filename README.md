...
-------------------------------------------------------------------------------
https://salsa.debian.org/efi-team/shim/-/tree/debian/15.6-1_deb11u1
...
older toolchains on arm64. We are *not* looking to get the arm64 shim
signed (these patches are a no-op for the x86 builds), but we still
need to build the binaries for stable updates in Debian Bullseye.
...
* ```shim_15.6-1~deb11u1_amd64.log```
* ```shim_15.6-1~deb11u1_arm64.log```
* ```shim_15.6-1~deb11u1_i386.log```
...
15a08b2166efb2141e0d21e77b2fb61b9005dc6f80c8ae0ae91f1bbb9048dc0b  shimia32.efi
0f8db91f4e202302e87cb6dd225b46258733758e0c9a44deda6f91b68df718b3  shimx64.efi
...
current version (2.06-3~deb11u1) for Debian Bullseye. It is derived
...
Bullseye is using Linux 5.10.127 (labelled as 5.10.127-1 in Debian). It
has the usual lockdown patches applied - see
https://salsa.debian.org/kernel-team/linux/-/tree/bullseye-security/
for the current config and patches.
