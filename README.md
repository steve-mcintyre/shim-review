...
-------------------------------------------------------------------------------
https://salsa.debian.org/efi-team/shim/-/tree/debian/15.6-1_deb10u1
...
need to build the binaries for stable updates in Debian Buster.
...
* ```shim_15.6-1~deb10u1_amd64.log```
* ```shim_15.6-1~deb10u1_i386.log```
...
current version (2.06-3~deb10u1) for Debian Buster. It is derived from
...
Buster is using Linux 4.19.249 (labelled as 4.19.249-1 in Debian). It
has the usual lockdown patches applied - see
https://salsa.debian.org/kernel-team/linux/-/tree/buster-security/
