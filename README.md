...
*******************************************************************************
Yes, we are using the source from https://github.com/rhboot/shim/releases/download/15.7/shim-15.7.tar.bz2

*******************************************************************************
### URL for a repo that contains the exact code which was built to get this binary:
*******************************************************************************
https://salsa.debian.org/efi-team/shim/-/tree/debian/15.7-1_deb11u1

*******************************************************************************
### What patches are being applied and why:
*******************************************************************************
Five patches (see the patches dir here, or in the debian/patches dir
in the shim repo)
...
- Make-sbat_var.S-parse-right-with-buggy-gcc-binutils.patch
  patch from upstream to work around toolchain bugs

- Enable-NX.patch
  patch from upstream to enable NX in our build

- block-grub-sbat3-debian.patch
  patch to disable loading Debian's GRUB packages tagged with SBAT 3
  due to a bug in an older release (https://bugs.debian.org/1024617)
  sent upstream and reviewed OK (https://github.com/rhboot/shim/pull/550)
...
We have included patches for all but two of these.

For those other two patches:
...
*******************************************************************************
We're now on grub.debian 4, due to the issue mentioned above
(https://bugs.debian.org/1024617)
...
Further known issues will be revoked by SBAT updates.
...
The binaries build reproducibly on Debian "unstable" as of 2023-02-08.
...
*******************************************************************************
* ```shim_15.7-1~deb11u1_amd64.log```
* ```shim_15.7-1~deb11u1_i386.log```

*******************************************************************************
### What changes were made since your SHIM was last signed?
*******************************************************************************
We've moved forwards from 15.4 to 15.7 and dropped all the patches we
used to need as they're upstream. Then added the 5 patches listed above.

*******************************************************************************
### What is the SHA256 hash of your final SHIM binary?
*******************************************************************************
977058ecbae4653adb557dcf9603ef861c240d944c442b2f2762e59811815800  shimia32.efi
c5f5e864de7380f93e511e0ca2a546a92f74179c5d5c107261b23058634d0cea  shimx64.efi
...
*******************************************************************************
https://salsa.debian.org/grub-team/grub.git, branch "bullseye" is the
current version (2.06-3_deb11u5) in Debian Bullseye. It is derived
from the upstream 2.06 release with a number of patches applied - see
...
*******************************************************************************
Bullseye is using Linux 5.10.162 (labelled as  5.10.0-21 in Debian). It
has the usual lockdown patches applied - see
https://salsa.debian.org/kernel-team/linux/-/treebullseye/debian/patches/features/all/lockdown
